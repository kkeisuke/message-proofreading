...
const EXAMPLES: Record<UsageScene, Example[]> = {
  business: [
    ...
    },
    {
      ...
      keyPoints: '・コード凍結の前倒しはOK\n・リリースノートは自分がやる\n・連絡先は今週中に直す',
      assistant:
        'お疲れさまです。整理いただきありがとうございます。\n凍結日は1週間繰り上げて調整します。QA に1週間取れる形になります。\nリリースノートは私が引き受けます。\n連絡先は今週中に最新のものへ差し替えます。',
    },
    {
      receivedMessage:
        '今後の進め方の参考にしたく存じますので、よかった点と改善してほしい点をお聞かせいただけますでしょうか。',
      keyPoints: '・返信が早くて助かった\n・仕様変更の共有をもっと早くほしかった',
      assistant:
        'ありがとうございます。\nよかった点は、問い合わせへの返信が早かったことです。判断に迷う時間が減りました。\n改善してほしい点は、仕様変更の共有です。もう少し早めにいただけると助かります。',
    },
  ],
  casual: [
    {
